...
export default function RequirePWA({ children }: RequirePWAProps) {
  ...
  return (
    <div className="min-h-screen bg-cosmic flex flex-col items-center justify-center px-6 relative overflow-hidden">
      {/* Glowing orbs */}
      ...
      <p className="text-dark-300 text-center mb-8 max-w-xs">
        ...
        {isIOS ? (
          ...
          <div className="card text-center">
            <div className="flex items-center justify-center gap-2 mb-4">
              <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-accent/20 to-accent-bright/20 flex items-center justify-center">
            ...
            <div className="flex items-center justify-center gap-2 text-dark-300 text-sm">
      ...
      {/* Footer */}
      <p className="absolute bottom-8 text-dark-500 text-xs">
