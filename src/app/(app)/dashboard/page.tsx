...
export default function DashboardPage() {
  ...
  return (
    <main className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-24 sm:pb-8 relative z-10">
      ...
      <div className="hidden sm:flex items-center gap-1 mb-8 p-1 bg-dark-800/50 rounded-xl border border-white/10 w-fit">
        <button
          onClick={() => switchTab('dashboard')}
          className={`px-4 py-2 rounded-lg text-sm font-medium transition-all duration-200 ${
            activeTab === 'dashboard'
              ? 'bg-accent/20 text-accent-light shadow-lg'
